        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <?php echo form_open('Downloads/addExam'); ?>
                        ...
                        <div class="row container-fluid">
                            <div class="col-md-12">
                                ...
                                <div class="input-group" style="margin-bottom:10px;">
                                    ...
                                    <textarea type="text" name="time" placeholder="Enter duration in minutes" class="form-control"> </textarea>
                                </div>
                        ...
                        <div class="row container-fluid">
                            <div class="col-md-12">
                                ...
                                <div class="input-group" style="margin-bottom:10px;">
                                    ...
                                    <textarea type="text" name="questions" placeholder="Enter no of questions" class="form-control"> </textarea>
                                </div>
